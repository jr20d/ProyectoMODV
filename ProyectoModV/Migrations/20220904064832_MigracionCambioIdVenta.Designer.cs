...
namespace ProyectoModV.Migrations
{
    ...
    [Migration("20220904064832_MigracionCambioIdVenta")]
    partial class MigracionCambioIdVenta
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProyectoModV.Models.Venta", b =>
                {
            ...
            modelBuilder.Entity("ProyectoModV.Models.VentaDetalle", b =>
                {
                    b.Property<int>("VentaDetalleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("VentaDetalleId"), 1L, 1);
            ...
            modelBuilder.Entity("ProyectoModV.Models.VentaDetalle", b =>
                {
                    b.HasOne("ProyectoModV.Models.Producto", "Producto")
                        .WithMany("VentaDetalles")
                        .HasForeignKey("ProductoId");

                    b.HasOne("ProyectoModV.Models.Venta", "Venta")
                        .WithMany("Detalle")
